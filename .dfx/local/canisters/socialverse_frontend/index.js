...
import { idlFactory } from './socialverse_frontend.did.js';
export { idlFactory } from './socialverse_frontend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SOCIALVERSE_FRONTEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./socialverse_frontend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the socialverse_frontend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./socialverse_frontend.did.js")._SERVICE>}
 */
export const socialverse_frontend = createActor(canisterId);
