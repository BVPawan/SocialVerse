...
import { idlFactory } from './socialverse_backend.did.js';
export { idlFactory } from './socialverse_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_SOCIALVERSE_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./socialverse_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the socialverse_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./socialverse_backend.did.js")._SERVICE>}
 */
export const socialverse_backend = createActor(canisterId);
